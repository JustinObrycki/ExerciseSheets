...
<exercise-card class:completed={exercise.done}>
    ...
    <p class="Sets">Sets: <input type="number" bind:value={exercise.sets} on:input={notifyOfChange}/></p>
    <p class="Reps">Reps: <input type="number" bind:value={exercise.reps} on:input={notifyOfChange}/></p>
    <p class="Warmup">Warmup: <input type="number" bind:value={exercise.warmup} on:input={notifyOfChange}/></p>
    <p class="Max">Max: <input type="number" bind:value={exercise.max} on:input={notifyOfChange}/></p>
